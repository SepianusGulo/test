    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/user/profile/{{$calon->id}}/update" method="POST" enctype="multipart/form-data">
                      {{ csrf_field() }}
            ...
            <div class="form-group{{$errors->has('posisi_yang_dilamar')? 'has-error': ''}}">
                    ...
                    <input type="text" name="posisi_yang_dilamar" class="form-control" placeholder="Silahkan isi nama posisi_yang_dilamar anda" value="{{$calon->posisi_yang_dilamar}}">
            ...
            <div class="form-group{{$errors->has('pendidikan_terakhir')? 'has-error': ''}}">
                    ...
                    <input type="text" name="pendidikan_terakhir" class="form-control" placeholder="Silahkan isi nama pendidikan_terakhir anda" value="{{$calon->pendidikan_terakhir}}">
            ...
            <div class="form-group{{$errors->has('nama_institusi')? 'has-error': ''}}">
                    ...
                    <input type="text" name="nama_institusi" class="form-control" placeholder="Silahkan isi nama nama_institusi anda" value="{{$calon->nama_institusi}}">
            ...
            <div class="form-group{{$errors->has('jurusan')? 'has-error': ''}}">
                    ...
                    <input type="text" name="jurusan" class="form-control" placeholder="Silahkan isi nama jurusan anda" value="{{$calon->jurusan}}">
            ...
            <div class="form-group{{$errors->has('tahun_lulus')? 'has-error': ''}}">
                    ...
                    <input type="text" name="tahun_lulus" class="form-control" placeholder="Silahkan isi nama tahun_lulus anda" value="{{$calon->tahun_lulus}}">
            ...
            <div class="form-group{{$errors->has('nama_kursus')? 'has-error': ''}}">
                    ...
                    <input type="text" name="nama_kursus" class="form-control" placeholder="Silahkan isi nama nama_kursus anda" value="{{$calon->nama_kursus}}">
            ...
            <div class="form-group{{$errors->has('sertifikat')? 'has-error': ''}}">
                    ...
                    <input type="text" name="sertifikat" class="form-control" placeholder="Silahkan isi nama sertifikat anda" value="{{$calon->sertifikat}}">
            ...
            <div class="form-group{{$errors->has('tahun')? 'has-error': ''}}">
                    ...
                    <input type="text" name="tahun" class="form-control" placeholder="Silahkan isi nama tahun anda" value="{{$calon->tahun}}">
                    @if($errors->has('tahun'))
            ...
            <div class="form-group{{$errors->has('nama_perusahaan')? 'has-error': ''}}">
                    ...
                    <input type="text" name="nama_perusahaan" class="form-control" placeholder="Silahkan isi nama nama_perusahaan anda" value="{{$calon->nama_perusahaan}}">
            ...
            <div class="form-group{{$errors->has('posisi_terakhir')? 'has-error': ''}}">
                    ...
                    <input type="text" name="posisi_terakhir" class="form-control" placeholder="Silahkan isi nama posisi_terakhir anda" value="{{$calon->posisi_terakhir}}">
            ...
            <div class="form-group{{$errors->has('pendapatan_terakhir')? 'has-error': ''}}">
                    ...
                    <input type="text" name="pendapatan_terakhir" class="form-control" placeholder="Silahkan isi nama pendapatan_terakhir anda" value="{{$calon->pendapatan_terakhir}}">
            ...
            <div class="form-group{{$errors->has('tahun_selesai')? 'has-error': ''}}">
                    ...
                    <input type="text" name="tahun_selesai" class="form-control" placeholder="Silahkan isi nama tahun_selesai anda" value="{{$calon->tahun_selesai}}">
